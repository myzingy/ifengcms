 ...
 */
class Mobile_Controller extends Site_Controller
{
	function Mobile_Controller()
	{
		parent::Site_Controller();

		// Set container variable
		$this->_container = $this->config->item('backendpro_template_public') . "mobile.php";

		// Set public meta tags
		//$this->bep_site->set_metatag('name','content',TRUE/FALSE);

		// Load the PUBLIC asset group
		$this->bep_assets->load_asset_group('MOBILE');
