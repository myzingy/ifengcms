...
$config['asset'][] = array('file'=>'jquery.form.js', 'needs'=>'jquery','name'=>'jqueryform');
...
//MOBILE
$config['asset'][] = array('file'=>base_url().'assets/css/mobile.css', 'name' => 'm_index');
$config['asset'][] = array('file'=>base_url().'assets/js/common.js', 'name' => 'm_index_all','needs'=>'m_index|jquery|jqueryform');
/**
 * Asset Groups
 * 
...
$config['asset_group']['ADMIN'] = 'reset|typography|bep_admin_layout|bep_admin_style|FlashStatus|forms|jqueryform|buttons|bep_navigation|treeview|bep_icons|bep_select_all|common|bep_generate_password.css|bep_generate_password.js';

$config['asset_group']['FORMS'] = "buttons|forms|validate";
//$config['asset_group']['GENERATE_PASSWORD'] = "bep_generate_password.js";

$config['asset_group']['MOBILE'] = "m_index_all";
