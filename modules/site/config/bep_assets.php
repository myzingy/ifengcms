...
$config['asset'][] = array('file'=>'jquery.dataTables.js', 'name'=>'dataTables');
//$config['asset'][] = array('file'=>'list_dataTables.js', 'needs'=>'dataTables');
$config['asset'][] = array('file'=>'jquery.validate.js', 'needs'=>'jquery','name'=>'validate');
$config['asset'][] = array('file'=>'common.js', 'needs'=>'jquery','name'=>'common');
//TEXTAREA
$config['asset'][] = array('file'=>'xheditor-1.1.14/xheditor-1.1.14-zh-cn.min.js', 'name'=>'xheditor1114');

//MOBILE
$config['asset'][] = array('file'=>base_url().'assets/zhangwen/lib/gmu.css', 'name' => 'gmu_css');
$config['asset'][] = array('file'=>base_url().'assets/zhangwen/css/scroll.css', 'name' => 'scroll_css', 'needs'=>'gmu_css');
$config['asset'][] = array('file'=>base_url().'assets/zhangwen/css/reset.css', 'name' => 'reset_css', 'needs'=>'scroll_css');
$config['asset'][] = array('file'=>base_url().'assets/zhangwen/lessCss/style.css', 'name' => 'style_css', 'needs'=>'reset_css');

$config['asset'][] = array('file'=>base_url().'assets/zhangwen/lib/zepto.min.js', 'name' => 'zepto');
$config['asset'][] = array('file'=>base_url().'assets/zhangwen/lib/gmu.min.js', 'name' => 'gmu', 'needs'=>'zepto');
$config['asset'][] = array('file'=>base_url().'assets/zhangwen/js/iscroll_init.js', 'name' => 'iscroll_init', 'needs'=>'gmu');
$config['asset'][] = array('file'=>base_url().'assets/zhangwen/js/fastclick.js', 'name' => 'fastclick', 'needs'=>'iscroll_init');
$config['asset'][] = array('file'=>base_url().'assets/zhangwen/js/pull_refresh.js', 'name' => 'pull_refresh', 'needs'=>'fastclick');
$config['asset'][] = array('file'=>base_url().'assets/zhangwen/js/page.js', 'name' => 'page', 'needs'=>'pull_refresh');
$config['asset'][] = array('file'=>base_url().'assets/zhangwen/js/page_init.js', 'name' => 'page_init', 'needs'=>'page', 'position'=>'header');
