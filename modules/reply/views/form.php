...
<?php print form_open_multipart('reply/admin/reply/keyword',array('class'=>'horizontal','id'=>'articleForm'))?>
        ...
        <ol>
            ...
            <li class="submit">
            	<div class="buttons">
            		...
            		<a href="<?php print site_url('reply/admin/reply/keylist') ?>" class="negative">
