...
<?php print form_open_multipart('ads/admin/ads/update',array('class'=>'horizontal','id'=>'articleForm'))?>
    ...
    <fieldset>
        <ol>
            ...
            <li>
                <label for="thumb1">广告图片(320*240)<br>(jpg|jpeg|png|bmp)
                <?php if($editinfo['src']):?>
            ...
            <li>
            	<label for="farmtype">广告位置<font color="red">*</font></label>
            	<span id="classify_dispaly">
                <?php
                $selectedArr=$editinfo['classify']?$editinfo['classify']:array();//文章选中的分类
				foreach($classify as $type=>$class):
					if($class):foreach($class as $pos=>$v):
                ...
                <label style="border: 0;border-left: solid 2px red; margin-left: 8px; ">&nbsp;</label>
                <?php endforeach;?>
            ...
            <li class="submit">
            	<div class="buttons">
            		...
            		<a href="<?php print site_url('ads/admin/ads/index') ?>" class="negative">
