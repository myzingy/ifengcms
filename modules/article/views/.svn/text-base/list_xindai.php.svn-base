...
<div class="buttons">                
	<a href="<?php print  site_url('article/admin/article/form/xindai')?>">
    <?php print  $this->bep_assets->icon('add');?>
    	添加信贷资讯
    </a>
</div><br/><br/>

<?php print form_open('article/admin/article/delete/xindai')?>
<table class="data_grid" cellspacing="0">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td><?php print $farmtype[$row['farmtype']]?></td>
			<td><?php print date("Y-m-d H:i:s",$row['addtime'])?></td>
            <td><?php print $this->bep_assets->icon($active);?></td>
            <td class="middle"><a href="<?php print site_url('article/admin/article/form/xindai/'.$row['id'])?>"><?php print $this->bep_assets->icon('pencil');?></a></td>
