...
class auth extends Public_Controller
{
	...
	function login($ajax='')
	{
		$this->auth_form_processing->login_form($this->_container,$ajax);
	}
	...
	{
		$this->auth_form_processing->register_form($this->_container,$ajax);
	}
	...
	function sendcode(){
		$this->auth_form_processing->sendcode();
	}
}
