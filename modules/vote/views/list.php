...
<div class="buttons">                
	<a href="<?php print  site_url('vote/admin/vote/update')?>">
...
<table class="data_grid" cellspacing="0">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td><a href="<?php print site_url('vote/admin/vote/votedata/'.$row['id']);?>"><?php print $row['title']?></a></td>
            <td><?php print $row['snum']?>-<?php print $row['enum']?></td>
            <td><?php print date("Y-m-d H时",$row['stime'])?> 至 <?php print date("Y-m-d H时",$row['etime'])?></td>
            <td>
            	<a target="_blank" href="<?php print site_url('vote/display/list/'.$row['id']);?>">查看</a>
            	&nbsp;|&nbsp;
            	<a target="_blank" href="<?php print site_url('vote/ifengvotereldata?rand=&vid='.$row['id']);?>" title="统计">统计 </a>
            	&nbsp;|&nbsp;
            	<a href="<?php print site_url('vote/admin/vote/update/'.$row['id']);?>" title="编辑"><?php print  $this->bep_assets->icon('pencil');?></a>
            	&nbsp;|&nbsp;
