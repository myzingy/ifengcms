...
<script type="text/javascript">
    ...
    var sharecfj = {
        ...
        desc:'我是来自<?php print $data->infor;?>的<?php print $data->name;?>，请关注“凤凰陕西”回复“<?php print $data->sn;?>为我投票”', // 分享描述
    ...
    <div class="players">
        <div class="player">
            ...
            <div class="infor2">
                ...
                <div class="votenum fr"><?php print $data->count;?></div>
                <div class="clear"></div>
            </div>
        </div>
        <a id="back" href='<?php print site_url( 'vote/display/list/'.$data->vid );?>'><img src="<?php print base_url()?>assets/vote_m_host2015/images/back_btn.png"></a>
    </div>
    <div class="foot">
        <p class="img">
