...
<?php print form_open_multipart('vote_zh/admin/vote/update',array('class'=>'horizontal','id'=>'articleForm'))?>
        ...
        <ol>
            ...
            <li class="submit">
            	<div class="buttons">
            		...
            		<a href="<?php print site_url('vote_zh/admin/vote/index') ?>" class="negative">
			...
			submitHandler: function() {
				$("#articleForm").ajaxSubmit({
					...
					success:function(json){
						console.log(json);
						if(json.status==0){
							location.href='<?php print site_url('vote_zh/admin/vote/index') ?>';
							return;
						}
						alert(json.error);
					}
