...
document.writeln("	margin:-50px auto 0 -100px;");
...
document.writeln("	<div id=\"title\" class=\"title\">消息提醒<span class=\"close\" id=\"alertclose\" onclick=\"document.getElementById('windowcenter').style.display='none';\"><\/span><\/div>");
document.writeln("	<div class=\"content\">");
document.writeln("	 <div id=\"txt\"><\/div>");
document.writeln("	 <input type=\"button\" value=\"确定\" id=\"windowclosebutton\" name=\"确定\" class=\"txtbtn\" onclick=\"document.getElementById('windowcenter').style.display='none';\">	");
